label lolita_boutique:
    ...
    k "Well ya know.. it is the holiday season..."
    r "Hmm... well you know what this calls for?"
    k "Oh?"
    r "SALESSSS!!"
    ...
    k "Woahh... wouldja look at that."
    k "This blouse looks real similar to the blouse ya wore when I followed ya on Kinsta..."
    r "EH?? {w}You remember something like that?"
    k "Yup!! I have a perfect recollection of ya even before our first interaction hehe..."
    r "Oh gosh..."
    r "I only remember up until I posted my photos..."
    ...
    k "Don’t worry bout’ it! I remember the rest."
    ...
    r "WAAAAHHH??? They still sell this here?"
    r "I guess it never went out of style..."
    k "Thanks to {i}my{/i} help hehe..."
    k "I wasn’t president of the fashion club in high school for nothing..."
    ...
    r "That jumperskirt (even though it is the most expensive one I own) is one of my favorite pieces!! I was starting to gain traction on Kinsta because of it."
    ...
    r "Being a lolita is already an expensive lifestyle as it is, so I clung to that piece a lot and posted it all the time."
    r "At some point I was getting tired of that jumperskirt. Untillll..."
    k "Until?"
    r "The most popular and cutest fashionista started following me!!"
    "I looked at Kuma and realized that even the simplest of compliments were still enough to make her blush."
    k "I really... {w}wanted to compliment you but I wasn’t bold enough to DM you immediately..."
    k "I decided reposting was the next best thing."
    k "I don’t know if you ever realized the impact my repost made, but my fans really loved your jumperskirt."
    r "Of course I noticed! I just didn’t think it would have such an impact that it would keep it in stores years later."
    r "Honestly... I don’t think you know the impact that singular repost had on me."
    r "Your repost made tons of kind people comment on my post and it helped me regain the confidence I had."
    k "What do you mean? I thought you loved that thing to death."
    r "Well..."
    r "At that point in time, I was thinking of giving up that lifestyle."
    r "Everything in my life kept going wrong and I was starting to let go of the things I held close to me."
    r "Then... the day you followed me!"
    r "I didn’t have the best day at school... so seeing that notification was like a reminder.."
    ...
    r "Even if it feels like you’ve been fighting forever, if you keep going, one day it’ll feel like you’ve been feeling euphoric forever!"
    k "I forgot how contrasting our high school lives were."
    k "It felt like I had a thriving high school life."
    ...
    k "Seeing you on Kinsta brought a feeling I’d never encountered before and hasn’t been replicated since."
    k "I can still feel the adrenaline rush sometimes. Not even the rival magazines’ drama has made me feel so on edge."
    r "The emotion sounds similar to what I felt that day..."
    ...
    r "Honestly you... you got so confident all of a sudden..."
