...
define config.name = _("I'm Dreaming of a Harajuku Christmas")
...
define build.name = "HarajukuChristmas"
...
define config.sample_sound = "audio/reina.wav"
...
label before_main_menu:
    if persistent.endingOne:
            play music "audio/apartmentend.mp3"
...
define config.save_directory = "IDOAHCprototype-1765996512"
