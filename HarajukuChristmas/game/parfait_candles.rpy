label parfait_candles:
    ...
    # transition black fade in then fade out
    # drag and drop mechanic here?

    "Step one: choose the jelly cube like gel wax."

    "I stare long and hard at the various gel wax colors to choose from."
    r "Which jelly cubes…."
    k "I got the blue and purple ones with gel wax."
    r "Then I’ll take the pink and orange ones!"
    # kuma smiling sprite
    k "Those colors kinda remind me of our outfits."

    "Step two: dip the gel wax in glitter and place them in the glass."
    ...
    "Step three: add melted wax to the glass."
    ...
    r "It’s like syrup.."
    k "I really want parfaits now."
    r "I get what you mean!"
    k "Can we get parfaits after this…?"
    r "Yeah!!"

    "Step four: Add your color of choice to the wax."
    ...
    "Step five: Create the ice cream scoop."
    ...
    "Step six: Put the ice cream scoops on top."
    ...
    k "I’m seeing the vision…"
    r "Right? Right?"
    k "I wouldn’t want to use this as a real candle."
    r "Let’s save it then! As a souvenir for today’s Christmas date!" 

    "Step seven: Place the whipped cream and sprinkles."

    "Note: it is not actually edible whipped cream and sprinkles. Just decorations for the candle!"
    ...
    k "Cute, cute as always Reina."
    r "^_^"
    r "And let me see yours…"
    ...
    k "Thank ya, thank ya."
    k "I was thinking about Mana-sama while making this. Y’know with the blue and purple."
    r "Huhu~"
    r "You got an eye for style…"
    "I snap some photos of our finished parfait candles. So cute!"
    k "Parfaits now? Pleeease."
    r "Alright, alright!"

    scene bg harujuku city with slow_dissolve

    k "Oh my god… that triple strawberry sundae parfait was so good.."
    r "I’m stuffed…"
    k "You got the mini parfait though?"
    r "Yeah but there was a lot on it!"
    r "It had twice the amount of strawberries and chocolate that yours had!"
    k "Yeah, yeah… and half the calories of mine apparently."
    r "We could’ve shared!"
    k "You have a point…"
    k "Where to next, Reina?"


    jump harujukuoptions